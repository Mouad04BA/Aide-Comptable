...
import { analyzeAccountingOperation } from '../services/geminiService';
...
const SimulatorPage: React.FC = () => {
  ...
  const formatNumber = (num: number | null | undefined) => {
    ...
    // Use locale from language context for appropriate number formatting
  ...
  return (
    <div className="container mx-auto px-6 py-12 animate-fade-in-down">
      ...
      <div className="max-w-3xl mx-auto mt-8 bg-white dark:bg-dark-card p-6 rounded-xl shadow-lg calculator-card">
      ...
      {result && (
        <div className="max-w-3xl mx-auto mt-8 space-y-6">
          <div className="bg-white dark:bg-dark-card p-6 rounded-xl shadow-lg animate-fade-in animation-delay-200">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl shadow-lg animate-fade-in animation-delay-400">
...
const ErrorMessage: React.FC<{ message: string }> = ({ message }) => (
  <div className="max-w-3xl mx-auto mt-8 p-4 text-center bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300 rounded-lg animate-fade-in">
    {message}
  </div>
);
