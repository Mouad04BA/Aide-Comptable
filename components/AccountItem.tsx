...
const AccountItem: React.FC<{ 
  ...
  return (
    <button 
      ...
      className="w-full flex justify-between items-center py-3 px-4 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 text-left transition-all duration-200 transform hover:translate-x-1 rtl:hover:-translate-x-1 active:bg-gray-100 dark:active:bg-gray-800"
    >
